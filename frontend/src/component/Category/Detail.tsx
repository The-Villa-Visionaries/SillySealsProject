    ...
    return (
        <>
            ...
            <div className="w-full flex flex-wrap gap-4 p-4 justify-center">
                <PanelCard type="Icon" value="Placeholder" description="Upload SVG icon" />
                <PanelCard type="CID" value="1"/>
                <PanelCard type="Color" value="#9F4EFF" description="Hex Color" />
                <PanelCard type="Priority Score" value="5 points" />
            </div>
