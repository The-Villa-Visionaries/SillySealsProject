...
export default function Card({ title, value, description, icon }: CardProps) {
    return (
        <div className="flex flex-col w-45 h-40 bg-white rounded-[20px] p-4 border-[#E2E8F0] border transition-transform duration-300 ease-out hover:scale-105 hover:cursor-pointer">
